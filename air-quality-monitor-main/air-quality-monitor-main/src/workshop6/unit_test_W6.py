...
def testKNN(sensors, query, k = 3, thresholds = [5, 10, 20, 40]):
    ...
    neighbors1 = knn_pollution(sensors, query, k=k, use_average=False)
    simple_knn = []
    ...
    neighbors2 = knn_geographic(sensors, query, k=k)
    geographic_knn = []
    ...
    neighbors3 = knn_alert(sensors, query, k=k)
    alert_knn = []
